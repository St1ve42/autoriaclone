...
router.post('/', strictAuthMiddleware.validateAccessToken, userMiddleware.checkUserIsBanned, commonMiddleware.validateUserPermission("CREATE_ANNOUNCEMENT"), commonMiddleware.validateBody(AnnouncementValidator.createAnnouncement),announcementController.create)
...
router.delete('/:announcementId', strictAuthMiddleware.validateAccessToken, userMiddleware.checkUserIsBanned, commonMiddleware.validateUserPermission("DELETE_ANNOUNCEMENT"), commonMiddleware.validateId("announcementId", "mongo"), commonMiddleware.validateEntityExisting<AnnouncementType>(announcementService, "Announcement", "announcementId"), announcementMiddleware.checkStrictAccess, announcementController.delete)
router.patch('/:announcementId', strictAuthMiddleware.validateAccessToken, userMiddleware.checkUserIsBanned, commonMiddleware.validateUserPermission("UPDATE_ANNOUNCEMENT"), commonMiddleware.validateId("announcementId", "mongo"), commonMiddleware.validateEntityExisting<AnnouncementType>(announcementService, "Announcement", "announcementId"), announcementMiddleware.checkStrictAccess, commonMiddleware.validateBody(AnnouncementValidator.updateAnnouncement), announcementController.update)
router.post('/:announcementId/images', strictAuthMiddleware.validateAccessToken, userMiddleware.checkUserIsBanned, commonMiddleware.validateUserPermission("CREATE_ANNOUNCEMENT"), commonMiddleware.validateId("announcementId", "mongo"), commonMiddleware.validateEntityExisting<AnnouncementType>(announcementService, "Announcement", "announcementId"), announcementMiddleware.checkStrictAccess, fileMiddleware.validateManyFiles("images", announcementConfig), announcementController.upload)
