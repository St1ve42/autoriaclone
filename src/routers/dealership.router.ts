...
router.post('/:dealershipId/reviews', strictAuthMiddleware.validateAccessToken, commonMiddleware.validateId("dealershipId", "mongo"), commonMiddleware.validateEntityExisting<DealershipType>(dealerShipService, "Dealership", "dealershipId"), commonMiddleware.validateBody(DealershipReviewValidator.createValidator), dealershipReviewController.create)
router.get('/:dealershipId/reviews', commonMiddleware.validateId("dealershipId", "mongo"), commonMiddleware.validateEntityExisting<DealershipType>(dealerShipService, "Dealership", "dealershipId"), commonMiddleware.validateQuery(QueryValidator.dealershipReviewValidator), dealershipReviewController.getList)
router.get('/:dealershipId/reviews/:reviewId', commonMiddleware.validateId("dealershipId", "mongo"), commonMiddleware.validateEntityExisting<DealershipType>(dealerShipService, "Dealership", "dealershipId"), commonMiddleware.validateId("reviewId", "mongo"), commonMiddleware.validateEntityExisting<DealershipReviewType>(dealershipReviewService, "Review", "reviewId"), dealershipReviewController.get)
router.patch('/:dealershipId/reviews/:reviewId', strictAuthMiddleware.validateAccessToken, commonMiddleware.validateId("dealershipId", "mongo"), commonMiddleware.validateEntityExisting<DealershipType>(dealerShipService, "Dealership", "dealershipId"), commonMiddleware.validateId("reviewId", "mongo"), commonMiddleware.validateEntityExisting<DealershipReviewType>(dealershipReviewService, "Review", "reviewId"), dealershipMemberMiddleware.checkReview, commonMiddleware.validateBody(DealershipReviewValidator.updateValidator), dealershipReviewController.update)
router.delete('/:dealershipId/reviews/:reviewId', strictAuthMiddleware.validateAccessToken, commonMiddleware.validateId("dealershipId", "mongo"), commonMiddleware.validateEntityExisting<DealershipType>(dealerShipService, "Dealership", "dealershipId"), commonMiddleware.validateId("reviewId", "mongo"), commonMiddleware.validateEntityExisting<DealershipReviewType>(dealershipReviewService, "Review", "reviewId"), dealershipMemberMiddleware.checkReview, dealershipReviewController.delete)
